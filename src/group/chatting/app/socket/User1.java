...
package group.chatting.app.socket;
...
public class User1  implements ActionListener, Runnable{
    ...
    User1(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Prof.png"));
        ...
        JLabel name = new JLabel("Ali's Malikane");
        name.setBounds(110,15,200,18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERİF",Font.BOLD,18));
        p1.add(name);
        
        JLabel status = new JLabel("Ali, Fikret , Messi , Mami ");
        status.setBounds(110,35,160,18);
        status.setForeground(Color.WHITE);
        status.setFont(new Font("SAN_SERİF",Font.BOLD,14));
        p1.add(status);
